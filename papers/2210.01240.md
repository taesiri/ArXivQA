# [Language Models Are Greedy Reasoners: A Systematic Formal Analysis of
  Chain-of-Thought](https://arxiv.org/abs/2210.01240)
...
## What is the TL;DR (Too Long, Didn't Read) version of the paper? If you had to summarize it in one sentence, what would that be?
 ...
 Unfortunately without access to the full text of the paper, I do not have enough context to provide a meaningful 1-sentence summary. Some key points I can glean from the partial LaTeX code:

- The paper introduces a new synthetic QA dataset called PrOntoQA for evaluating reasoning capabilities of large language models (LLMs). 

- The examples in PrOntoQA are generated from symbolic ontologies and proofs to allow formal analysis of the reasoning steps predicted by LLMs. 

- Experiments are conducted with models like InstructGPT and GPT-3.

- The analysis shows that while LLMs can produce valid individual reasoning steps, they struggle with planning ahead and choosing the right steps, especially as proof length increases. 

- Real-world knowledge from pretraining helps LLMs reason better compared to fictional or counterfactual settings.

To summarize, the paper introduces a new synthetic QA dataset PrOntoQA to evaluate reasoning skills of LLMs, and finds LLMs are limited in multi-step deductive reasoning and planning, especially without real-world knowledge. But without seeing the full paper, it's difficult for me to provide an accurate 1-sentence summary. Please let me know if you can provide more context.
