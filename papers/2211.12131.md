# [DiffDreamer: Towards Consistent Unsupervised Single-view Scene
  Extrapolation with Conditional Diffusion Models](https://arxiv.org/abs/2211.12131)
...
## What is the TL;DR (Too Long, Didn't Read) version of the paper? If you had to summarize it in one sentence, what would that be?
 ...
 Unfortunately without reading the full paper, I do not have enough context to provide a high-quality 1-sentence summary. However, based on skimming the sections, figures, and captions, here is my attempt at a very brief summary:

This paper proposes a novel unsupervised framework called DiffDreamer that uses conditional diffusion models to generate consistent novel views by flying into a single input image, training only on collections of unrelated internet images.
