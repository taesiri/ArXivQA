...
Here is a one sentence summary of the paper:The paper proposes IRCoT, a new approach for multi-step QA that interleaves retrieval with reasoning steps in a chain-of-thought, using each to guide the other and improve both retrieval and QA performance without training.
