...
This paper proposes a conceptual framework called Cognitive Architectures for Language Agents (CoALA) to systematically understand and develop language agent systems, drawing inspiration from the history of symbolic AI and cognitive architectures.
