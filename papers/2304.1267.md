# [Asymptotic expansions for the maximum likelihood estimation errors of
  the rotating parameter of the gravitational wave from core-collapse
  supernovae](https://arxiv.org/abs/2304.1267)
