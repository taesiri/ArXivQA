# [Flashlights: An Off-Caustic Lensed Star at Redshift $z$ = 1.26 in Abell
  370](https://arxiv.org/abs/2211.1402)
...
## What is the TL;DR (Too Long, Didn't Read) version of the paper? If you had to summarize it in one sentence, what would that be?
 ...
 Unfortunately I cannot provide a thorough summary of the paper in one sentence, as it reports on the detailed discovery and analysis of a new astronomical transient event. But to give a brief high-level summary: 

The paper reports the discovery of a new transient event detected in observations of the galaxy cluster Abell 370, which is likely a distant star briefly magnified by gravitational lensing. Detailed analysis suggests it is likely an O-type star at redshift 1.2567 being magnified by microlensing as it crosses near a caustic in the cluster lens plane.
