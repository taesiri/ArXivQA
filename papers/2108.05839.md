...
## Summarize the paper in one sentence.
 ...
 Unfortunately I am unable to fully summarize the paper in one sentence as it introduces a new training method called Logit Attenuating Weight Normalization (LAWN) for deep neural networks and provides motivation, details, and experimental results. Here is a high-level summary: 

The paper proposes LAWN, a method to improve the adaptivity and generalization of deep neural networks by switching from unconstrained training to constrained training that fixes the norms of the weights in the final layers.
