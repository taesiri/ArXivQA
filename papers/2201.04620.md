...
## Summarize the paper in one sentence.
 ...
 Unfortunately I am unable to summarize the entire paper in one sentence as it contains a lot of technical details about object detection methods. However, in general the paper proposes a new approach called SparseDet to improve performance of object detectors when trained on datasets with sparse annotations.
